...
abstract final class AppTheme {
  static ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      labelLarge: AppTextStyle.heading2
          .copyWith(color: Colors.black, fontWeight: FontWeightManager.bold),
      labelMedium: AppTextStyle.heading4
          .copyWith(color: Colors.black, fontWeight: FontWeightManager.bold),
      titleLarge: AppTextStyle.heading2
          .copyWith(color: Colors.black, fontSize: FontSize.s22),
      titleMedium: AppTextStyle.heading3
          .copyWith(color: Colors.black, fontWeight: FontWeightManager.medium),
      titleSmall: AppTextStyle.heading4.copyWith(
          color: Colors.black,
          fontSize: FontSize.s14,
          fontWeight: FontWeightManager.medium),
      displayLarge: AppTextStyle.heading1
          .copyWith(color: Colors.black, fontWeight: FontWeightManager.medium),
      displayMedium: AppTextStyle.heading4.copyWith(
        color: Colors.black,
        fontSize: FontSize.s14,
      ),
      ...
      bodySmall: AppTextStyle.paragraph1
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      unselectedLabelStyle:
          AppTextStyle.grey16BookCaros.copyWith(color: AppColor.darkGreen),
    ),
  );
  static ThemeData darkTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      labelLarge: AppTextStyle.heading2
          .copyWith(color: Colors.white, fontWeight: FontWeightManager.bold),
      labelMedium: AppTextStyle.heading4
          .copyWith(color: Colors.white, fontWeight: FontWeightManager.bold),
      titleLarge: AppTextStyle.heading2
          .copyWith(color: Colors.white, fontSize: FontSize.s22),
      titleMedium: AppTextStyle.heading3
          .copyWith(color: Colors.white, fontWeight: FontWeightManager.medium),
      titleSmall: AppTextStyle.heading4.copyWith(
          color: Colors.white,
          fontSize: FontSize.s14,
          fontWeight: FontWeightManager.medium),
      ...
      bodySmall: AppTextStyle.paragraph1
          .copyWith(color: Colors.white, fontSize: FontSize.s12),
    ),
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      backgroundColor: AppColor.white,
      selectedItemColor: AppColor.darkGreen,
